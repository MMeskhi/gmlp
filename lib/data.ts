...
import dabadeba from "@/public/dabadeba.png";
import nebi from "@/public/nebi.png";
import nebiProducts from "@/public/nebi-products.png";
import zuni from "@/public/zuni.png";
...
export const projectsData = [
  {
    title: "Dabadeba",
    description: "Platform for Girchi",
    tags: ["Vue.js", "Laravel"],
    imageUrl: dabadeba,
    link: "https://dabadeba.ge/",
  },
  {
    title: "Nebi",
    description: "Platform for Nebi Products brand",
    tags: ["Nextjs"],
    imageUrl: nebi,
    link: "https://nebi.com/",
  },
  {
    title: "Nebi Products",
    description: "Platform for Nebi Products management App",
    tags: ["React.js", ".Net"],
    imageUrl: nebiProducts,
    link: "https://products.nebi.com/",
  },
  {
    title: "Zuni Sports",
    description:
      "Platform for all football tournaments and competitions in the world",
    tags: ["Vue.js", "Laravel"],
    imageUrl: zuni,
    link: "https://zunisport.com/",
  },
  {
